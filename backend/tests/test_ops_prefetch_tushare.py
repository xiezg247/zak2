...
def test_prefetch_upserts_basic() -> None:
    ...
    with (
        patch("app.services.ops.prefetch_tushare.ts.require_token", return_value="tok"),
        patch("app.services.ops.prefetch_tushare.latest_open_yyyymmdd", return_value="20260811"),
        patch("app.services.ops.prefetch_tushare.fetch_daily_basic_rows", return_value=basic_rows),
        patch("app.services.ops.prefetch_tushare.fetch_moneyflow_rows", return_value=flow_rows),
