...
def test_moneyflow_upserts() -> None:
    ...
    with patch("app.services.ops.prefetch_moneyflow.ts.require_token", return_value="tok"), patch(
        "app.services.ops.prefetch_moneyflow.latest_open_yyyymmdd", return_value="20260811"
    ), patch(
        "app.services.ops.prefetch_moneyflow.fetch_moneyflow_rows", return_value=rows
