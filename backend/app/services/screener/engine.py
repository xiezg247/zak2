...
from app.services.screener.hard_filters import apply_hard_filters, resolve_hard_filter
from app.services.screener.presets import get_builtin_recipe, get_preset
...
def run_recipe_screen(
    ...
    *,
    ...
    if recipe.recipe_id == "radar_resonance":
        from app.services.screener import resonance_screen
