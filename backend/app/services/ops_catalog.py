...
JOB_SPECS: tuple[JobSpec, ...] = (
    ...
    JobSpec("sync_suspend_daily", "停牌日同步", "停牌记录增量", "sync_suspend_daily"),
    JobSpec("prefetch_tushare", "Tushare 因子预拉", "daily_basic 等本地缓存", "prefetch_tushare"),
    ...
    JobSpec("sync_disclosure_calendar", "同步披露计划", "财报预约披露日", "sync_disclosure_calendar"),
    ...
    JobSpec("warm_radar_card_snapshots", "雷达卡片预热", "雷达卡片快照", "warm_radar_card_snapshots"),
    JobSpec(
        "sync_bilibili_feed",
        "B站订阅同步",
