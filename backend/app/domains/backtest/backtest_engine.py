...
from app.domains.backtest.backtest_bars import Bar, load_daily_bars
...
STRATEGIES = (
    ...
    },
    {
        ...
        "category": "trend",
        "tags": ["趋势", "ADX", "止损"],
        "default_params": "20/60 · ADX 14/25 · 止损 12%",
        "featured": True,
        "implemented": True,
        "engine": "vnpy",
    },
    {
        ...
        "category": "trend",
        "tags": ["趋势", "MACD", "中线"],
        "default_params": "MACD 12/26/9 · 趋势线 60",
        "featured": True,
        "implemented": True,
        "engine": "vnpy",
    },
