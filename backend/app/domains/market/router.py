"""市场/板块/雷达薄路由：Depends + 域模块函数，路径保持 /market/* /sectors/* /radar/*。"""
...
from app.domains.emotion import emotion_thresholds as emotion_thresholds_svc
from app.domains.market import overview as market_svc
from app.domains.market import sector as sector_svc
from app.domains.market.limit_list_store import list_limit_list
...
from app.domains.radar import radar_horizon as radar_horizon_svc
from app.domains.radar import radar_predict as radar_predict_svc
from app.domains.radar import radar_resonance as resonance_svc
